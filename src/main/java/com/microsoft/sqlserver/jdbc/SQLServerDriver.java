...
public final class SQLServerDriver implements java.sql.Driver {
    ...
    private static final SQLServerDriverPropertyInfo[] DRIVER_PROPERTIES =
    {
        ...
        new SQLServerDriverPropertyInfo(SQLServerDriverStringProperty.PIPE_PATH.toString(),          		      			  SQLServerDriverStringProperty.PIPE_PATH.getDefaultValue(),      		      				  			  false,      null),
        ...
        new SQLServerDriverPropertyInfo(SQLServerDriverIntProperty.PIPE_MAX_PKTS.toString(),          		      			  Integer.toString(SQLServerDriverIntProperty.PIPE_MAX_PKTS.getDefaultValue()),      		      		  false,      null),
